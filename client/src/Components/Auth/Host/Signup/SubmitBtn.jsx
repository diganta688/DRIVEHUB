...
function SubmitBtn({ isSubmit, error, passValidationError }) {    
    const isDisabled = isSubmit || error || passValidationError;
  ...
  return (
    ...
    >
      {isSubmit ? "Loading..." : <><UserPlus className="w-5 h-5" /><span style={{ marginLeft: "0.5rem" }}>Sign In</span></>}
    </button>
  );
}
