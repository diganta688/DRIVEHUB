    ...
    <div className="flex flex-col gap-2 align-items-center w-full md:w-auto justify-center">
      ...
      >
        <div className="flex items-center justify-between w-full px-2 py-1">
          <div className="text-sm font-semibold truncate">{searchParams.get("city") || "Unknown Location"}</div>
          <div>
            <Link
        ...
        <div className="flex flex-col flex-row sm:items-center gap-1 text-gray-600 w-full justify-center py-1 text-xs">
          <div className="text-center sm:text-right">
            <div className="font-medium text-black truncate">{searchParams.get("startDate") || "Start Date"}</div>
          ...
          <div className="text-center sm:text-left">
            <div className="font-medium text-black truncate">{searchParams.get("endDate") || "End Date"}</div>
